package org.opengis.cite.coveragejson10.level1;

import java.io.IOException;
import java.net.URL;
import javax.xml.transform.Source;
import javax.xml.transform.dom.DOMSource;
import org.opengis.cite.coveragejson10.CommonFixture;
import org.opengis.cite.coveragejson10.ErrorMessage;
import org.opengis.cite.coveragejson10.ErrorMessageKeys;
import org.opengis.cite.coveragejson10.SuiteAttribute;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.coveragejson10.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/coveragejson10/rnc/atom.rnc");
